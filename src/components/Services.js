  ...
  return (
    <>
      ...
      <div className={gStyles.content}>
        ...
        <br /><br />
        We will tutor any level of math between grades 6 and 12. Lower grades may also be accepted on a case-by-case basis.
        <div className={gStyles.header} style={{ marginBottom: '0.5rem', marginTop: '2rem' }}>Recommended Sessions</div>
        Two 1-hour sessions per week is recommended, though more or less
        can be accommodated according to need.
        <div className={gStyles.header} style={{ marginBottom: '0.5rem', marginTop: '2rem' }}>Pricing</div>
        A 1-hour session is $30. Other session lengths are at the same rate,
        $30/hr.
      </div>
      <Footer />
    </>
